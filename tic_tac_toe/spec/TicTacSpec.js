define(['TicTac'], function(TicTac){
    describe("TicTac", function() {
        ...
        describe('moveElement', function(){
            it('should move 1 from available to playerOne.squares', function(){
                tic.moveElement(tic.playerOne.squares, 1);
                expect(tic.available).toEqual([2, 3, 4, 5, 6, 7, 8, 9]);
                expect(tic.playerOne.squares).toEqual([1]);
            });

            it('should move 5 from available to playerOne.squares', function(){
                tic.moveElement(tic.playerOne.squares, 5);
                expect(tic.available).toEqual([1, 2, 3, 4, 6, 7, 8, 9]);
                expect(tic.playerOne.squares).toEqual([5]);
            });

            it('should move 7 from available to playerOne.squares, then move 3 from available the playerOne.squares', function(){
                tic.moveElement(tic.playerOne.squares, 7);
                tic.moveElement(tic.playerOne.squares, 3);
                expect(tic.available).toEqual([1, 2, 4, 5, 6, 8, 9]);
                expect(tic.playerOne.squares).toEqual([3, 7]);
            });

            it('should move 7 from available to playerOne.squares, then move 3 from available the playerTwo.squares', function(){
                tic.moveElement(tic.playerOne.squares, 7);
                tic.moveElement(tic.playerTwo.squares, 3);
                expect(tic.available).toEqual([1, 2, 4, 5, 6, 8, 9]);
