define(['AI', 'TicTac'], function(AI, TicTac){
    describe('AI', function(){
        describe('move', function(){
            ...
            it('playerOne ai should win if it can', function(){
                ...
                tic.possibleWins();
                tic.possibleForks();
                tic.moveElement(tic.playerOne.squares, ai.move(tic.playerOne, tic.playerTwo, tic.available))
            ...
            it('playerTwo ai should win if it can', function(){
                ...
                tic.possibleWins();
                tic.possibleForks();
                tic.moveElement(tic.playerTwo.squares, ai.move(tic.playerTwo, tic.playerOne, tic.available))
